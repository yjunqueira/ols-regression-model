...
data = dados[['marketprice', 'giga-hashrate']].dropna()

# Executar o teste de Granger invertido
...
# Plotar os resultados do teste de Granger invertido
...
plt.ylabel('Valor-p')
plt.title('Teste de Granger: marketprice -> hashrate')
plt.xticks(lags)
plt.show()
